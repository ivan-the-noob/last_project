<?php
    ...
    // Query to fetch the waiting appointments
    $sql = "SELECT * FROM appointment WHERE status = 'waiting'";
    ...
    // Query to get the total number of waiting appointments
    $countSql = "SELECT COUNT(*) as total FROM appointment WHERE status = 'waiting'";
    if ($search) {
