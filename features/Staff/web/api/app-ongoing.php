<?php
    ...
    // Query to fetch the on-going appointments
    $sql = "SELECT * FROM appointment WHERE status = 'on-going'";
    ...
    // Query to get the total number of on-going appointments
    $countSql = "SELECT COUNT(*) as total FROM appointment WHERE status = 'on-going'";
    if ($search) {
        ...
        <div class="navbar-links">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="checkoutDropdowns">
                    ...
                    <li><a class="dropdown-item  navbar-highlight" href="app-ongoing.php"><i class="fa-solid fa-calendar-check"></i> <span>On Going Bookings</span></a></li>
                    ...
                    <tbody>
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo "<td>" . ($row['payment_option'] === 'onStore' ? 'Cash' : $row['payment_option']) . "</td>";
                                echo "<td>
